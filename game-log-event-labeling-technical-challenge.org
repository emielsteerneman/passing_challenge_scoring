...
#+CAPTION: File Formats and Utilities. See for PDF version with clickable links: [[file:ssl-game-log-labeling-figs/file_format_flowchart.pdf][clickable PDF version]]
