...
the robot cannot get behind it. Since teams might have different extra space
between the field boundaries and the wall, the json file can be edited to match
this criteria.
